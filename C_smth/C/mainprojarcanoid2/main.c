...
int randomBalljump;
/*float randomMoveBall(int limit)//!!!!!!!!!
{
    int randposition, randnum;
    srand(time(NULL));
    randnum = rand();
    randposition = randnum%3;
    return randposition;
}*/
...
void autoMoveBall()
{
    ...
    if((mas[ball.iy][ball.ix] == '#') || (mas[ball.iy][ball.ix] == '@'))//make 4 blocks
    {
